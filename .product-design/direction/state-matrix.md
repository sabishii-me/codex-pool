...
| S7 | Mobile landscape · member | Models | Search/filter with focused input and open route details | Compact shell is used by default, the drawer and scrollbars are intentional, actions remain visible, and no root horizontal overflow occurs |
