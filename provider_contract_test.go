...
func providerContractMatrix() []providerContract {
	...
	return []providerContract{
		...
		{NewKimiProvider(anthropic), "anthropic-messages", "model", verified("shared stream fixture and proxy integrity contract"), verified("shared JSON fixture and proxy exactly-once contract"), verified("cache-read usage parsed"), partial("cache-write parsed but analytics schema does not persist it"), verified("shared reasoning fixture"), verified("shared Anthropic translation path"), partial("streamed route/body integrity verified; end-to-end fixture pending"), partial("legacy analytics exactly-once verified; no canonical request ID")},
		{NewKimiPlatformProvider(anthropic), "anthropic-messages", "model", verified("shared stream fixture and proxy integrity contract"), verified("shared JSON fixture and proxy exactly-once contract"), verified("cache-read usage parsed"), partial("cache-write parsed but analytics schema does not persist it"), verified("shared reasoning fixture"), verified("shared Anthropic translation path"), partial("streamed route/body integrity verified; end-to-end fixture pending"), partial("legacy analytics exactly-once verified; no canonical request ID")},
		{NewMinimaxProvider(anthropic), "anthropic-messages", "model", verified("shared stream fixture and proxy integrity contract"), verified("shared JSON fixture and proxy exactly-once contract"), verified("cache-read usage parsed"), partial("cache-write parsed but analytics schema does not persist it"), verified("shared reasoning fixture"), verified("shared Anthropic translation path"), partial("streamed route/body integrity verified; end-to-end fixture pending"), partial("legacy analytics exactly-once verified; no canonical request ID")},
		{NewZAIProvider(anthropic), "anthropic-messages", "model", verified("shared stream fixture and proxy integrity contract"), verified("shared JSON fixture and proxy exactly-once contract"), verified("cache-read usage parsed"), partial("cache-write parsed but analytics schema does not persist it"), verified("shared reasoning fixture"), verified("shared Anthropic translation path"), partial("streamed route/body integrity verified; end-to-end fixture pending"), partial("legacy analytics exactly-once verified; no canonical request ID")},
		{NewXiaomiProvider(anthropic), "anthropic-messages", "model", verified("shared stream fixture and proxy integrity contract"), verified("shared JSON fixture and proxy exactly-once contract"), verified("cache-read usage parsed"), partial("cache-write parsed but analytics schema does not persist it"), verified("shared reasoning fixture"), verified("shared Anthropic translation path"), verified("large body model peek plus shared route/body integrity"), partial("legacy analytics exactly-once verified; no canonical request ID")},
		...
		{NewDeepSeekProvider(anthropic), "anthropic-messages", "model", verified("shared stream fixture and proxy integrity contract"), verified("shared JSON fixture and proxy exactly-once contract"), verified("cache-read usage parsed"), partial("cache-write parsed but analytics schema does not persist it"), verified("shared reasoning fixture"), verified("shared Anthropic translation path"), partial("streamed route/body integrity verified; end-to-end fixture pending"), partial("legacy analytics exactly-once verified; no canonical request ID")},
		{NewQwenProvider(anthropic), "anthropic-messages", "model", verified("shared stream fixture and proxy integrity contract"), verified("shared JSON fixture and proxy exactly-once contract"), verified("cache-read usage parsed"), partial("cache-write parsed but analytics schema does not persist it"), verified("shared reasoning fixture"), verified("shared Anthropic translation path"), partial("streamed route/body integrity verified; end-to-end fixture pending"), partial("legacy analytics exactly-once verified; no canonical request ID")},
		{NewOpenRouterProvider(anthropic), "anthropic-messages", "model", verified("shared stream fixture and proxy integrity contract"), verified("shared JSON fixture and proxy exactly-once contract"), verified("cache-read usage parsed"), partial("cache-write parsed but analytics schema does not persist it"), verified("shared reasoning fixture; routed upstream semantics can vary"), verified("shared Anthropic translation path"), partial("streamed route/body integrity verified; end-to-end fixture pending"), partial("legacy analytics exactly-once verified; no canonical request ID")},
		{NewNvidiaProvider(openAI), "openai-chat", "model", verified("final stream usage chunk parser"), verified("non-streaming usage parser"), verified("nested prompt cached tokens parsed"), gap("cache-write semantic unavailable"), verified("nested completion reasoning tokens parsed"), verified("Claude to OpenAI Chat translation path"), partial("streamed route/body integrity verified; protocol translation requires buffering"), gap("canonical event persistence not characterized")},
	}
}
