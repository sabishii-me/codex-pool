...
func (pw *poolWatcher) reloadPool() {
	...
	log.Printf("hot-reload complete: codex=%d gemini=%d antigravity=%d kimi=%d minimax=%d zai=%d xiaomi=%d grok=%d deepseek=%d qwen=%d openrouter=%d nvidia=%d",
		counts[AccountTypeCodex], counts[AccountTypeGemini],
