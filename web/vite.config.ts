...
export default defineConfig({
  ...
  server: {
    proxy: {
      "/api": "http://127.0.0.2:18991",
      "/admin": "http://127.0.0.2:18991",
      "/auth": "http://127.0.0.2:18991",
      "/setup": "http://127.0.0.2:18991",
      "/config": "http://127.0.0.2:18991",
      "/hero.webp": "http://127.0.0.2:18991",
    },
  },
});
